...
class RolesList
  class << self
    ...
    def default_role
      {
        'Default role' => { :permissions => [:view_bookmarks, :view_tasks, :access_user_columns], :description => 'Role that is automatically assigned to every user in the system. Adding a permission grants it to everybody' }
      }
    end
